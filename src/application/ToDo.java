...
import application.commonClasses.client.Client_Controller;
import application.commonClasses.client.Client_Model;
import application.commonClasses.client.Client_View;
import application.splashScreen.Splash_Controller;
import application.splashScreen.Splash_Model;
import application.splashScreen.Splash_View;
import javafx.application.Application;
import javafx.application.Platform;
import javafx.stage.Stage;

public class ToDo extends Application {
    private static ToDo mainProgram; // singleton
    ...
    protected static ToDo getMainProgram() {
        return mainProgram;
    }
}
